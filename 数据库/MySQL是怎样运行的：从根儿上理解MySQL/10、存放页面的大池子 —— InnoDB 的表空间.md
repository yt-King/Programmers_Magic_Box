...
![image_1crjupisqne61uer17ikh6l1v8k9.png-44.9kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006818.webp)
...
![image_1cri1nutcorp5ghf5c7vqagt1j.png-71.4kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006853.webp)
...
![image_1crjo0hl4q8u1dkdofe187b10fa9.png-105.2kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006844.webp)
...
![image_1crre79uq9971bsdj9s1i0j11en8a.png-96.2kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006847.webp)
...
- `List Node`（12字节）
  ...
  ![image_1crre8tlh1vmqtfipk663l173q97.png-69.1kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006863.webp)
...
![image_1crrehf6i1jsq1j5cubj1mdoh77a4.png-81.6kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006869.webp)
...
![image_1crrju0cnji91a2fhv91ijb15hgb1.png-111.4kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006137.webp)
...
到现在为止我们已经大概清楚了表空间、段、区、XDES Entry、INODE Entry、各种以`XDES Entry`为节点的链表的基本概念了，可是总有一种飞在天上不踏实的感觉，每个区对应的`XDES Entry`结构到底存储在表空间的什么地方？直属于表空间的`FREE`、`FREE_FRAG`、`FULL_FRAG`链表的基节点到底存储在表空间的什么地方？每个段对应的`INODE Entry`结构到底存在表空间的什么地方？我们前边介绍了每256个连续的区算是一个组，想解决刚才提出来的这些个疑问还得从每个组开头的一些类型相同的页面说起，接下来我们一个页面一个页面的分析，真相马上就要浮出水面了。

#### `FSP_HDR`类型

首先看第一个组的第一个页面，当然也是表空间的第一个页面，页号为`0`。这个页面的类型是`FSP_HDR`，它存储了表空间的一些整体属性以及第一个组内256个区的对应的`XDES Entry`结构，直接看这个类型的页面的示意图：

![image_1crmfvigk938c8h1hahglr15329.png-146.8kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006167.webp)
...
![image_1crrp2qp310rc10fd33ch716hcp.png-148.1kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006263.webp)
...
![image_1cs3vmoii1h971aje1iveack1l109.png-149.5kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006330.webp)
...
![img](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006590.webp)
...
![image_1d6a74gu41fuqcqm1htri771d1k16.png-65.1kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006611.webp)
...
![image_1csbied27ohe1rgg32gquulplm.png-147.4kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006698.webp)
...
![img](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006773.webp)
...
![image_1d9ppsbelendcbb13hghhn18pe9.png-3564.2kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208151006854.webp)