...
![image_1d36k7d3412oo1c0qcuuben12l79.png-31.3kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642970.webp)
...
![image_1d3fv01mv3jd7m719rpmn2jcsp.png-42.6kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642984.webp)
...
![image_1d3fv8at819jh1m7m1sfb1donvmu16.png-47.2kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642952.webp)
...
![image_1d3gv4i7vtsirf81ikl1q2140n2g.png-67.2kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642977.webp)
...
![image_1d3bn8tsq1ssp1nmdks8kdr17e31t.png-85.7kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642974.webp)
...
- 情况一：该数据页的剩余的空闲空间充足，足够容纳这一条待插入记录，那么事情很简单，直接把记录插入到这个数据页中，记录一条类型为`MLOG_COMP_REC_INSERT`的`redo`日志就好了，我们把这种情况称之为`乐观插入`。假如某个索引对应的`B+`树长这样：
  ...
  ![image_1d4fc7b6b1ftt16ji11as4a63h23.png-30.8kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642941.webp)
  ...
  ![image_1d4fcbg9e1m1b1qtj1emgphorrl2g.png-43.3kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642837.webp)
...
- 情况二：该数据页剩余的空闲空间不足，那么事情就悲剧了，我们前边说过，遇到这种情况要进行所谓的`页分裂`操作，也就是新建一个叶子节点，然后把原先数据页中的一部分记录复制到这个新的数据页中，然后再把记录插入进去，把这个叶子节点插入到叶子节点链表中，最后还要在内节点中添加一条`目录项记录`指向这个新创建的页面。很显然，这个过程要对多个页面进行修改，也就意味着会产生多条`redo`日志，我们把这种情况称之为`悲观插入`。假如某个索引对应的`B+`树长这样：
  ...
  ![image_1d4fcomne1lpsp691hg2o416hh2t.png-44.5kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642806.webp)
  ...
  ![image_1d4fkn8gv1n7enuq23kt1n1uvk3n.png-96.9kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642785.webp)
...
- 有的需要保证原子性的操作会生成多条`redo`日志，比如向某个索引对应的`B+`树中进行一次悲观插入就需要生成许多条`redo`日志。
  ...
  ![image_1d4fna6k51fok1mpd1tikkmihg144.png-15kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642876.webp)
  ...
  ![image_1d4fol2v71fjalphluu1kuf1d8t4h.png-41.4kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642881.webp)
...
- 有的需要保证原子性的操作只生成一条`redo`日志，比如更新`Max Row ID`属性的操作就只会生成一条`redo`日志。
  ...
  ![image_1d4fqlji7md35pdmvvhvibqb4u.png-27.4kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211642873.webp)
...
![image_1d4hgjr7t4es1v2mf2b1bt51rf95b.png-27.6kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211643244.webp)
...
![image_1d4hor6e7nq1mkm1sa41he71rif75.png-57.2kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211643352.webp)
...
![image_1d4hp4u8g13e317mkngoag21clv7i.png-113.9kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211643323.webp)
...
![image_1d4i4orkr17vl1m5l3hl1l341pad1j.png-76.5kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211643445.webp)
...
![image_1d4jsb3pac9t1pl76drruf1b0574.png-98.4kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211643399.webp)
...
![image_1d4ie92r31t57c94e661n861skv2t.png-95.1kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211643439.webp)
...
![image_1d4jsd7861q6dn9n17gs1cdd1kek7h.png-102.6kB](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-8/202208211643697.webp)
