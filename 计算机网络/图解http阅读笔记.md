...
### [我画了13张图，用最通俗易懂的话讲HTTPS，拿下！](https://juejin.cn/post/7042158171778973732#heading-14)
...
Google 在 2010 年发布了 SPDY（取自 SPeeDY，发音同 speedy），其开发目标旨在解决 HTTP 的**性能瓶颈**，缩短 Web 页面的加载时间（50%）。
...
2. SPDY 的设计与功能
   ...
   ![image-20220524114535984](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-5/202205241145061.png)
...
1. WebSocket 的设计与功能
   ...
   Web 浏览器与 Web 服务器之间**全双工通信标准**，WebSocket 协议由 IETF 定为标准，WebSocket API 由 W3C 定为标准。WebSocket 技术主要是为了解决 Ajax 和 Comet里 XMLHttpRequest 附带的缺陷所引起的问题。
...
动态 HTML 技术是通过调用客户端脚本语言 JavaScript，实现对HTML 的 Web 页面的动态改造。利用 DOM（Document Object
Model，文档对象模型）可指定欲发生动态变化的 HTML 元素。
...
![image-20220524135628314](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-5/202205241356373.png)
...
3. 针对 Web 应用的攻击模式
   ...
   - 以服务器为目标的被动攻击
     ...
     >
     > ![image-20220524143542609](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-5/202205241435676.png)

### 11.2 因输出值转义不完全引发的安全漏洞

1. [跨站脚本攻击](https://juejin.cn/post/6844903943143718925)
2. [SQL 注入攻击](https://juejin.cn/post/6960849763688251406#heading-1)
3. [OS 命令注入攻击](https://juejin.cn/post/6844903704320016398)
4. [HTTP 首部注入攻击](https://segmentfault.com/a/1190000039704976)
...
1. 会话劫持
   ...
   ![image-20220524163333146](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-5/202205241633226.png)

2. 会话固定攻击

   对以窃取目标会话 ID 为主动攻击手段的会话劫持而言，会话固定攻击（Session Fixation）攻击会强制用户使用攻击者指定的会话 ID，属于被动攻击。

   ![image-20220524163536811](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-5/202205241635891.png)
...
3. 跨站点请求伪造
   ...
   ![image-20220524163857654](https://typora-imagehost-1308499275.cos.ap-shanghai.myqcloud.com/2022-5/202205241638737.png)
