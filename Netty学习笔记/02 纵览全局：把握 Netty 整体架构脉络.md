...
![Drawing 2.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/Ciqc1F-NO9yAeCsoAAHf2YCqjsQ005.png)
...
![Drawing 3.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/Ciqc1F-NO_CABg8ZAAW1jtSV2JU753.png)
...
EventLoopGroup 本质是一个线程池，主要负责接收 I/O 请求，并分配线程执行处理请求。下图讲述了 EventLoopGroups、EventLoop 与 Channel 的关系。

<img src="https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/CgqCHl-NPG6APzDfAAbX5ACAFh8001.png" alt="Drawing 4.png" style="zoom: 50%;" />
...
![Drawing 5.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/Ciqc1F-NPHWAH8ExAAkQr2tQ9xM350.png)
...
EventLoopGroup 是 Netty 的**核心处理引擎**，那么 EventLoopGroup 和 Reactor 线程模型到底是什么关系呢？其实 EventLoopGroup 是 Netty Reactor 线程模型的**具体实现方**式，Netty 通过创建不同的 EventLoopGroup 参数配置，就可以支持 Reactor 的三种线程模型：
...
<img src="https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/CgqCHl-NPJ-AHaUvAA7mpp9SCqY582.png" alt="Drawing 6.png" style="zoom:50%;" />

从上图可以看出，ChannelPipeline 中包含入站 ChannelInboundHandler 和出站 ChannelOutboundHandler 两种处理器，我们结合客户端和服务端的数据收发流程来理解 Netty 的这两个概念。

![Drawing 7.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/CgqCHl-NPKaASxvgAAFHMPYQFhM940.png)
...
![Drawing 8.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/CgqCHl-NPK-ADq0pAABb1k5Zwu8681.png)
...
![Drawing 9.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/Ciqc1F-NPLeAPdjRAADyud16HmQ759.png)
...
![Drawing 10.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/Ciqc1F-NPNOAcv3mAA2V7Vw0BwM920.png)
...
![Lark20201021-150506.png](https://learn.lianglianglee.com/专栏/Netty 核心原理剖析与 RPC 实践-完/assets/Ciqc1F-P3fWANKZLAAT_BOSXVzg420.png)
